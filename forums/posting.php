...
// Topic subtitles were added
$uninit = array('post_attachment' => 0, 'poster_id' => $user->data['user_id'], 'enable_magic_url' => 0, 'topic_status' => 0, 'topic_type' => POST_NORMAL, 'post_subject' => '', 'topic_title' => '', 'post_time' => 0, 'post_edit_reason' => '', 'notify_set' => 0, 'topic_desc' => '');
...
$template->assign_vars(array(
	...
	// Topic subtitles
	'TOPIC_DESC'			=> $post_data['topic_desc'],																	 
	'S_DESC_TOPIC'			=> ($auth->acl_get('f_topic_desc', $forum_id) && ($mode == 'post' || ($mode == 'edit' && $post_data['topic_first_post_id'] == $post_data['post_id']))) ? true : false,
