...
function JT_init()
{
	jQuery("a.jTip").attr('href', function(){ return this.href.replace(' ','%20');} );
...
function JT_show(url,linkId,title)
{
	...
	if(hasArea>((params['width']*1)+75)){
		jQuery("body").append("<div id='JT' class='"+className+"' style='display:none;width:"+params['width']*1+"px'><div id='JT_arrow'></div><div id='JT_copy'></div>");//right side
		var arrowOffset = getElementWidth(linkId) + 11;
		var clickElementx = getAbsoluteLeft(linkId) + arrowOffset; //set x position
		jQuery('#JT_arrow').addClass('JT_arrow_left');
	}else{
		jQuery("body").append("<div id='JT' class='"+className+"' style='display:none;width:"+params['width']*1+"px'><div id='JT_arrow' style='left:"+((params['width']*1)+1)+"px'></div><div id='JT_copy'></div>");//left side
