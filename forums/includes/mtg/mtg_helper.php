<?php
/*
Plugin Name: WP MtG-Helper
Plugin URI:  http://www.backseatsurfer.de/wp-mtg-helper/
Description: Mtg Helper supports you writing "Magic:the Gathering"-articles
Version: 1.1.2b
Author: Sebastian Sebald with Modifications by Mark Diehr
Author URI: http://www.backseatsurfer.de/
*/
...
function mtgh_filter_plugin_actions_new($links) {
	...
	$settings_link = '<a href="mtg_helper.php">Settings</a>';
