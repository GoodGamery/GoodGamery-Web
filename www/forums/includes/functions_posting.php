...
function topic_review($topic_id, $forum_id, $mode = 'topic_review', $cur_post_id = 0, $show_quote_button = true)
{
	...
	if ($mode == 'topic_review')
	{
		...
		$template->assign_var('QQUOTE_IMG', $user->img('icon_post_qquote', $user->lang['REPLY_WITH_QQUOTE']));
		$template->assign_var('QQ_IMG', $user->img('icon_post_qq', $user->lang['REPLY_WITH_QQUOTE']));
	}
