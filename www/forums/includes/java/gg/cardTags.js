        ...
        for (var bnum = 0; bnum < blocks.length; bnum++) {
            ...
            for (var ix = 0; ix < lines.length; ix++) {
                ...
                if (parsed == undefined) {
                    ...
                    out_text += parsed.count + ' <a href="https://goodgamery.com/api/mtg/html?card=' + cardNameSafe + '" class="jTip" name=""  onclick=\'window.open("http://scryfall.com/search?q=!%27' + cardNameSafe + '%27")\' >' + parsed.name + '</a><br/>';
