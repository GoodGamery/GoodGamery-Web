...
$template->assign_vars(array(
	...
	'QQUOTE_IMG' 		=> $user->img('icon_post_qquote', 'REPLY_WITH_QUOTE'),
	'QQ_IMG' 			=> $user->img('icon_post_qq', 'REPLY_WITH_QUOTE'),
...
for ($i = 0, $end = sizeof($post_list); $i < $end; ++$i)
{
	...
	$unparsed_message = $message_parser->message;

	$unparsed_message = str_replace("\\", "\\\\", $unparsed_message);

	$unparsed_message = str_replace("'", "\\'", $unparsed_message);

	$unparsed_message = str_replace("\n", "\\n", $unparsed_message);
